...
class GeneticAlgorithm:
    ...
    def get_best_cromosome(self, cromo1, cromo2):
        ...
        return cromo1 if comparison_values[0] < comparison_values[1] else cromo2

            
    def generate_new_cromosome(self, parent1, parent2):
        ...
        temp_id1 = parent1[pos1]
        temp_id2 = parent1[pos2]
        child2 = [i for i in parent1]
        child2[pos1] = temp_id2
        child2[pos2] = temp_id1

        # seleccionando el mejor cromosoma de los 4
        temp_best_cromo = self.get_best_cromosome(parent1, parent2)
        temp_best_cromo = self.get_best_cromosome(temp_best_cromo, child1)
        temp_best_cromo = self.get_best_cromosome(temp_best_cromo, child2)
