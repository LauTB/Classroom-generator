...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.group_counter2 = QtWidgets.QSpinBox(self.frame_7)
        self.group_counter2.setObjectName("group_counter2")
        self.horizontalLayout_3.addWidget(self.group_counter2)
        ...
        self.year = QtWidgets.QSpinBox(self.frame_10)
        self.year.setMinimum(2020)
        self.year.setMaximum(2060)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 144, 530))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 149, 530))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 135, 530))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Cantidad de Grupos de la Primera sesión:"))
        self.label_5.setText(_translate("MainWindow", "Cantidad de Grupos de la Segunda sesión:"))
        self.label_8.setText(_translate("MainWindow", "Escoja el Año del Curso en cuestión"))
        self.label_3.setText(_translate("MainWindow", "Categoria Primera Sesión"))
        self.label_6.setText(_translate("MainWindow", "Categoria Segunda Sesión"))
        self.label_7.setText(_translate("MainWindow", "Categorias Globales"))
